        ...
        <div className="glass-panel p-6 md:p-8 w-full max-w-md mx-auto relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative">
                        <input
                            ...
                            placeholder="0.00"
                            className="input-field pr-24 text-2xl font-mono"
                        />
                        <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-2 bg-black/40 rounded-lg p-1">
                            <button
                                onClick={() => setCurrency('ETH')}
                                className={`px-2 py-1 rounded text-xs font-bold transition-colors ${currency === 'ETH' ? 'bg-white/20 text-white' : 'text-gray-500'
                                    }`}
                            >
                                ETH
                            </button>
                ...
                <button
                    ...
                    disabled={!amount || !selectedPlayer}
